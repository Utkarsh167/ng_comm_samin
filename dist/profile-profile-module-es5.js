...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppModulesProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_profile_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ProfileComponent(_editProfileService) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ProfileDetails() {
          ...
          this._editProfileService.getProfileDetails().subscribe(function (resp) {
        ...
        value: function onUpdateProfile() {
          ...
          this.isEdit = false;
          var data = Object.assign({}, this.editProfileForm.value, {
            email: this.userData.email
          });

          this._editProfileService.editProfile(data).subscribe(function (response) {
            _this2.ProfileDetails();
          }, function (error) {// this.changePasswordForm.enable();
          });
        }
      }, {
        key: "onCancel",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_profile_service__WEBPACK_IMPORTED_MODULE_2__["ProfileService"]])], ProfileComponent);
    /***/
  },
  ...
  function srcAppModulesProfileProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_profile_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./service/profile.service */
    "./src/app/modules/profile/service/profile.service.ts");
    /* harmony import */
    ...
    ProfileModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(profileRoutes), _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_pipes_absolute_routing_absolute_routing_module__WEBPACK_IMPORTED_MODULE_5__["AbsoluteRoutingModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], src_app_pipes_validation_error_validation_error_pipe_module__WEBPACK_IMPORTED_MODULE_9__["ValidationErrorPipeModule"]],
  ...
  /***/
  function srcAppModulesProfileServiceProfileServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_constant_url__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ProfileService(_formBuilder, _http, _utilityService, // private _dataService: DataTransferService,
      ...
      _createClass(ProfileService, [{
        key: "createEditProfileForm",
        value: function createEditProfileForm() {
        ...
        value: function getProfileDetails() {
          return this._http.get(src_app_constant_url__WEBPACK_IMPORTED_MODULE_7__["PROFILEDETAILS"], {
            userId: this.userId
          });
        }
      }, {
        ...
        value: function editProfile(data) {
          ...
          var body = Object.assign({}, data); //   delete body['email'];

          return this._http.put(src_app_constant_url__WEBPACK_IMPORTED_MODULE_7__["SUPERADMIN"], body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (response) {// if (response['statusCode'] === 200) {
            ...
            _this3._utilityService.errorAlert(error);
