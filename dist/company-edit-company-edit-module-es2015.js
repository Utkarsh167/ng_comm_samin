...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CompanyEditModule", function() { return CompanyEditModule; });
...
/* harmony import */ var src_app_directives_google_places_google_places_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/directives/google-places/google-places.module */ "./src/app/directives/google-places/google-places.module.ts");
/* harmony import */ var _component_company_edit_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./component/company-edit.component */ "./src/app/modules/layout/company/company-edit/component/company-edit.component.ts");
/* harmony import */ var _service_company_edit_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./service/company-edit.service */ "./src/app/modules/layout/company/company-edit/service/company-edit.service.ts");
/* harmony import */ var src_app_directives_number_only_number_only_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/directives/number-only/number-only.module */ "./src/app/directives/number-only/number-only.module.ts");
...
let CompanyEditModule = class CompanyEditModule {
};
CompanyEditModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
        ...
        imports: [
            ...
            src_app_directives_google_places_google_places_module__WEBPACK_IMPORTED_MODULE_9__["GooglePlacesModule"],
...
/* harmony import */ var _service_company_edit_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/company-edit.service */ "./src/app/modules/layout/company/company-edit/service/company-edit.service.ts");
...
/* harmony import */ var src_app_constant_absolute_routes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/constant/absolute-routes */ "./src/app/constant/absolute-routes.ts");
/* harmony import */ var src_app_modules_shared_services_utility_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/modules/shared/services/utility.service */ "./src/app/modules/shared/services/utility.service.ts");
...
let CompanyEditComponent = class CompanyEditComponent {
    constructor(_companyEditService, _fb, _router, _route, _uitilityService) {
    ...
    getCabDetail() {
        this._companyEditService
            ...
            .subscribe(response => {
            if (!response.data) {
                this._router.navigate([src_app_constant_absolute_routes__WEBPACK_IMPORTED_MODULE_6__["COMPANY"]]);
            }
    ...
    getAndSetFormValue(data) {
        ...
        data.contactNumber.map(phone => {
            this.contactNumber.push(this._fb.group({
    ...
    editCompany(formValue) {
        ...
        if (formValue.address) {
            if (formValue.latitude && formValue.longitude) {
                ...
                this._companyEditService.editCompany(data).subscribe(resp => {
                    if (resp && resp.statusCode == 200) {
                        this._router.navigate([src_app_constant_absolute_routes__WEBPACK_IMPORTED_MODULE_6__["COMPANY"]]);
                    }
                }, err => {
...
CompanyEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./company-edit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/layout/company/company-edit/component/company-edit.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./company-edit.component.scss */ "./src/app/modules/layout/company/company-edit/component/company-edit.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_company_edit_service__WEBPACK_IMPORTED_MODULE_3__["CompanyEditService"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
        _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
        _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"],
        src_app_modules_shared_services_utility_service__WEBPACK_IMPORTED_MODULE_7__["UtilityService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CompanyEditService", function() { return CompanyEditService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let CompanyEditService = class CompanyEditService {
    ...
    editCompany(data) {
        return this._http.put(src_app_constant_url__WEBPACK_IMPORTED_MODULE_6__["EDIT_COMPANY"], data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(response => {
            this._uitilityService.showAlert(src_app_constant_message__WEBPACK_IMPORTED_MODULE_9__["COMMON_MESSAGES"]['UPDATED']('Company'));
            return response;
...
CompanyEditService.ctorParameters = () => [
...
CompanyEditService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=company-edit-company-edit-module-es2015.js.map