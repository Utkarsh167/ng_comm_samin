...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-account-account-module"], {
  ...
  function srcAppModulesAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _account_routing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./account.routing */
    ...
    AccountModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _account_routing__WEBPACK_IMPORTED_MODULE_4__["AccountRoutingModule"]]
    })], AccountModule);
    /***/
  },
  ...
  /***/
  function srcAppModulesAccountAccountRoutingTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_guards_account_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var accountRoutes = [{
      ...
      children: [{
        path: '',
        redirectTo: _constant_routes__WEBPACK_IMPORTED_MODULE_4__["LOGIN"],
        pathMatch: 'full'
      }, {
        path: _constant_routes__WEBPACK_IMPORTED_MODULE_4__["LOGIN"],
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | login-login-module */
          "login-login-module").then(__webpack_require__.bind(null,
          /*! ./login/login.module */
          "./src/app/modules/account/login/login.module.ts")).then(function (m) {
            return m.LoginModule;
          });
        },
        canLoad: [src_app_guards_account_guard__WEBPACK_IMPORTED_MODULE_5__["AccountGuard"]],
        canActivate: [src_app_guards_account_guard__WEBPACK_IMPORTED_MODULE_5__["AccountGuard"]]
      }, {
        path: _constant_routes__WEBPACK_IMPORTED_MODULE_4__["FORGOT_PASSWORD"],
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          ...
          "./src/app/modules/account/forgot-password/forgot-password.module.ts")).then(function (m) {
        ...
        path: "".concat(_constant_routes__WEBPACK_IMPORTED_MODULE_4__["RESET_PASSWORD"], "/:token"),
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          ...
          "./src/app/modules/account/reset-password/reset-password.module.ts")).then(function (m) {
