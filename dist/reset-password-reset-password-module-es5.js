...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["reset-password-reset-password-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesAccountResetPasswordComponentResetPasswordComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesAccountResetPasswordComponentResetPasswordComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesAccountResetPasswordComponentResetPasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _service_reset_password_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ResetPasswordComponent(_accountService, _route) {
      ...
      _createClass(ResetPasswordComponent, [{
        ...
        value: function resetPassword() {
          ...
          var data = Object.assign({}, this.resetForm.value);
          this.resetForm.disable();
          data['token'] = this.token;

          this._accountService.resetPassword(data).subscribe(function (response) {}, function (err) {
            _this.resetForm.enable();
          });
        }
      }]);
    ...
    ResetPasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/account/reset-password/component/reset-password.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./reset-password.component.scss */
      "./src/app/modules/account/reset-password/component/reset-password.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_reset_password_service__WEBPACK_IMPORTED_MODULE_3__["ResetPasswordService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], ResetPasswordComponent);
    /***/
  },
  ...
  /***/
  function srcAppModulesAccountResetPasswordResetPasswordModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _component_reset_password_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _service_reset_password_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./service/reset-password.service */
    "./src/app/modules/account/reset-password/service/reset-password.service.ts");

    var routes = [{
      path: '',
      component: _component_reset_password_component__WEBPACK_IMPORTED_MODULE_5__["ResetPasswordComponent"]
    }];
    ...
    ResetPasswordModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], src_app_pipes_validation_error_validation_error_pipe_module__WEBPACK_IMPORTED_MODULE_8__["ValidationErrorPipeModule"]],
  ...
  /***/
  function srcAppModulesAccountResetPasswordServiceResetPasswordServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_modules_shared_services_form_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var _constant_url__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../../../../constant/url */
    "./src/app/constant/url.ts");
    /* harmony import */


    var src_app_constant_routes__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ResetPasswordService(_formBuilder, _http, _utilityService, _router, _formService) {
      ...
      _createClass(ResetPasswordService, [{
        ...
        */
        ...
        value: function resetPassword(data) {
          ...
          return this._http.post("".concat(_constant_url__WEBPACK_IMPORTED_MODULE_11__["RESET_PASSWORD"], "?accessToken=").concat(data.token), {
            password: data.password
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(function (response) {
            _this2.resetPasswordSuccess();
            ...
            if (error.error.statusCode === 400 && error.error.responseType === 'INVALID_TOKEN') {
              _this2._router.navigate(["/".concat(src_app_constant_routes__WEBPACK_IMPORTED_MODULE_12__["LINK_EXPIRED"])]);
            }
        ...
        */
        ...
        value: function resetPasswordSuccess() {
          var _this3 = this;
          ...
          this._utilityService.openDialog(data).subscribe(function (success) {
            if (_this3._router.url.startsWith('/account')) _this3._router.navigate([_constant_absolute_routes__WEBPACK_IMPORTED_MODULE_8__["LOGIN"]]);
          });
        }
      }]);
    ...
    ResetPasswordService.ctorParameters = function () {
      return [{
    ...
    ResetPasswordService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _shared_services_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"], _shared_services_utility_service__WEBPACK_IMPORTED_MODULE_5__["UtilityService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], src_app_modules_shared_services_form_service__WEBPACK_IMPORTED_MODULE_9__["FormService"]])], ResetPasswordService);
    /***/
  },
